package com.mangocity.data.hadoop.mapreduce.tool4;
...
public class ArvoFileTransRunner extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception {
		conf.set(HadoopConstants.REDUCE_OUT_PATH, args[args.length-1]);
...
//		AvroJob.setMapOutputValueSchema(job, schema);
        ...
        AvroMultipleOutputs.addNamedOutput(job, "meger", AvroKeyOutputFormat.class, schema);
